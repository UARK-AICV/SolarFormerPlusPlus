...
model_path="${PathToSolarFormer}/Pre-Trained_Models/Branch/"
img_path="${PathToSolarFormer}/mask2former/SolarPV/Branch/test_imgs"
output_path="${PathToSolarFormer}/demo_outputs/Branch"
