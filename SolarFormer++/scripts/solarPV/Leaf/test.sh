...
model_path="${PathToSolarFormer}/Pre-Trained_Models/Leaves/"
img_path="${PathToSolarFormer}/mask2former/SolarPV/Leaves/test_imgs"
output_path="${PathToSolarFormer}/demo_outputs/Leaves"
