...
model_path="${PathToSolarFormer}/Pre-Trained_Models/Dirt/"
img_path="${PathToSolarFormer}/mask2former/SolarPV/Dirt/test_imgs"
output_path="${PathToSolarFormer}/demo_outputs/Dirt"
