...
model_path="${PathToSolarFormer}/Pre-Trained_Models/multi_model/"
img_path="${PathToSolarFormer}/mask2former/SolarPV/multi_model/test_imgs"
output_path="${PathToSolarFormer}/demo_outputs/multi_model"
