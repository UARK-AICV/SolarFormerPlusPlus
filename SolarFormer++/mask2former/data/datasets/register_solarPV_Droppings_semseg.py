...
def register_idrid_semseg(root, split='train'):
    meta = {
        ...
        "thing_classes": ["0","1","2"],
        "stuff_classes": ["BG","SP","BD"],
        "thing_colors": [(0,0,0), (255,255,255), (255,255,255)],
        "stuff_colors": [(0,0,0), (255,255,255), (255,255,255)]
    }
    root = os.path.join(root, 'solarPV/Droppings')
    image_dir = os.path.join(root, '{}_imgs'.format(split))
    gt_dir = os.path.join(root, '{}_gt'.format(split))

    sem_key = 'solarPV_droppings_semseg_{}'.format(split)
