...
def register_idrid_semseg(root, split='train'):
    meta = {
        "thing_classes": ["Solar PV","Branch","Paper","Leaf","Dirt","Droppings"],
        "stuff_classes": ["Solar PV","Branch","Paper","Leaf","Dirt","Droppings"],
        "thing_colors": [(255,0,0), (0,255,0), (0,0,255), (255,255,0), (0,255,255), (255,0,255)],
        "stuff_colors": [(255,0,0), (0,255,0), (0,0,255), (255,255,0), (0,255,255), (255,0,255)]
    }
    root = os.path.join(root, 'solarPV/Multi_Model')
    image_dir = os.path.join(root, '{}_imgs'.format(split))
    gt_dir = os.path.join(root, '{}_gt'.format(split))

    sem_key = 'solarPV_multi_semseg_{}'.format(split)
